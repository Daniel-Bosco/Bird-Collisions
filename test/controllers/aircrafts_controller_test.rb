...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference('Aircraft.count') do
      post aircrafts_url, params: { aircraft: { category: @aircraft.category, certification: @aircraft.certification, model: @aircraft.model } }
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { category: @aircraft.category, certification: @aircraft.certification, model: @aircraft.model } }
