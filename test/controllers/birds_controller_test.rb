...
class BirdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post birds_url, params: { bird: { common_name: @bird.common_name, scientific_name: @bird.scientific_name } }
    end
  ...
  test "should update bird" do
    patch bird_url(@bird), params: { bird: { common_name: @bird.common_name, scientific_name: @bird.scientific_name } }
