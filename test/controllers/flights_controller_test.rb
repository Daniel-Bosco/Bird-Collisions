...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flight" do
    assert_difference('Flight.count') do
      post flights_url, params: { flight: { aircraft_id: @flight.aircraft_id, pilot_id: @flight.pilot_id } }
    end
  ...
  test "should update flight" do
    patch flight_url(@flight), params: { flight: { aircraft_id: @flight.aircraft_id, pilot_id: @flight.pilot_id } }
