...
class PilotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post pilots_url, params: { pilot: { birth_date: @pilot.birth_date, document: @pilot.document, first_name: @pilot.first_name, last_name: @pilot.last_name, privilege_level: @pilot.privilege_level } }
    end
  ...
  test "should update pilot" do
    patch pilot_url(@pilot), params: { pilot: { birth_date: @pilot.birth_date, document: @pilot.document, first_name: @pilot.first_name, last_name: @pilot.last_name, privilege_level: @pilot.privilege_level } }
